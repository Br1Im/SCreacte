...
export type QuestComplexity = 'simple' | 'medium' | 'complex';
export type QuestTone = 'light' | 'serious' | 'dark' | 'humorous';
...
export interface GeneratorInput {
  ...
  fileContent?: string;
  inputMethod: 'form' | 'file';
  // Новые поля для детальной настройки
  sceneCount?: number;
